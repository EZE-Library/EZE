...
.. code-block:: python
    ...
    class PreviousEZEIcons(Screen):

        def set_list_eze_icons(self, text="", search=False):
            '''Builds a list of icons for the screen EZEIcons.'''
    ...
    class MainApp(EZE App):
        ...
        def on_start(self):
            self.screen.set_list_eze_icons()
