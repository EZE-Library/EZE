...
.. tabs::
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            from eze.app import EZEApp
            from eze.uix.bottomsheet import EZEBottomSheet
            from eze.uix.boxlayout import EZEBoxLayout
            from eze.uix.imagelist import EZESmartTile
...
Add elements to :class:`~EZEBottomSheetDragHandleTitle` class
------------------------------------------------------------
...
Add custom content to :class:`~EZEBottomSheet` class
---------------------------------------------------
...
.. code-block:: python
    ...
    from eze.app import EZEApp
    from eze.uix.behaviors import TouchBehavior
    from kivyezemd.uix.boxlayout import EZEBoxLayout
    from eze.utils import asynckivy

    KV = '''
    #:import MapSource kivy_garden.mapview.MapSource
    #:import asynckivy eze.utils.asynckivy
    ...
    <TypeMapElement>
        ...
        EZEIconButton:
            id: icon
            icon: root.icon
            eze_bg_color: "#EDF1F9" if not root.selected else app.theme_cls.primary_color
            pos_hint: {"center_x": .5}
    ...
    class TypeMapElement(EZEBoxLayout):
...
from eze.uix.behaviors import CommonElevationBehavior, TouchBehavior
from eze.uix.boxlayout import EZEBoxLayout
...
class BottomSheetDragHandle(EZEWidget):
    pass


class BottomSheetDragHandleContainer(EZEBoxLayout):
    pass


class BottomSheetScrimLayer(EZEWidget):
    """
...
class EZEBottomSheetContent(EZEBoxLayout):
    """
...
class EZEBottomSheetDragHandleButton(EZEIconButton):
    """
    Implements a close button (or other functionality) for the
    :class:`~EZEBottomSheetDragHandle` container.
...
class EZEBottomSheetDragHandleTitle(EZELabel):
    """
    Implements a header for the :class:`~EZEBottomSheetDragHandle` container.

    For more information, see in the
    :class:`~eze.uix.label.MDLabel` class documentation.

    .. versionadded:: 1.2.0
    """


class EZEBottomSheetDragHandle(EZEBoxLayout):
    """
    ...
    def add_widget(self, widget, *args, **kwargs):
        if isinstance(
            widget,
            (EZEBottomSheetDragHandleTitle, EZEBottomSheetDragHandleButton),
        ):
...
class EZEBottomSheet(EZEBoxLayout, CommonElevationBehavior, TouchBehavior):
    """
    Bottom sheet class.

    For more information, see in the
    :class:`~eze.uix.boxlayout.EZEBoxLayout` and
    :class:`~eze.uix.behaviors.touch_behavior.CommonElevationBehavior` and
    :class:`~eze.uix.behaviors.touch_behavior.TouchBehavior`
    ...
    _touch_sheet = False
    # eze.uix.bottomsheet.bottomsheet.BottomSheetScrimLayer object.
    ...
    def dismiss(self, *args) -> None:
        ...
        if self.type == "modal":
            Animation(
                eze_bg_color=self.scrim_layer_color[:-1] + [0],
                d=self.duration_closing if self.animation else 0,
    ...
    def open(self, *args) -> None:
        ...
        if self.type == "modal":
            ...
            Animation(
                eze_bg_color=self.scrim_layer_color[:-1] + [alpha_channel_value],
                d=self.duration_opening if self.animation else 0,
            ).start(self._scrim_layer)
    ...
    def add_widget(self, widget, *args, **kwargs):
        if isinstance(widget, EZEBottomSheetDragHandle):
            self.ids.drag_handle_container.add_widget(widget)
            return
        elif isinstance(widget, EZEBottomSheetContent):
...
class EZECustomBottomSheet(EZEBottomSheet):
    """
    .. deprecated:: 1.2.0
        Use :class:`~eze.uix.bottomsheet.bottomsheet.EZEBottomSheet`
        class instead.
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Logger.warning(
            "EZE: "
            "The `EZECustomBottomSheet` class has been deprecated. "
            "Use the `EZEBottomSheet` class instead."
        )


class EZEListBottomSheet(EZEBottomSheet):
    """
    .. deprecated:: 1.2.0
        Use :class:`~eze.uix.bottomsheet.bottomsheet.EZEBottomSheet`
        class instead.
    ...
    def __init__(self, *args, **kwargs):
        ...
        Logger.warning(
            "EZE: "
            "The `EZEListBottomSheet` class has been deprecated. "
            "Use the `MDBottomSheet` class instead."
        )


class EZEGridBottomSheet(EZEBottomSheet):
    """
    .. deprecated:: 1.2.0
        Use :class:`~eze.uix.bottomsheet.bottomsheet.EZEBottomSheet`
        class instead.
    ...
    def __init__(self, *args, **kwargs):
        ...
        Logger.warning(
            "EZE: "
            "The `EZEGridBottomSheet` class has been deprecated. "
            "Use the `EZEBottomSheet` class instead."
        )
