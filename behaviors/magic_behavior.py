...
.. warning:: Magic effects do not work correctly with `EZE` buttons!
...
.. code-block:: kv
    ...
    <MagicButton@MagicBehavior+EZERectangleFlatButton>

In `python file`:

.. code-block:: python

    class MagicButton(MagicBehavior, EZERectangleFlatButton):
        pass
