...
.. code-block:: python
    ...
    from eze.uix.behaviors import CircularRippleBehavior
...
.. code-block:: python
    ...
    from eze.app import EZEApp
    from eze.uix.behaviors import RectangularRippleBehavior, BackgroundColorBehavior
...
class CommonRipple:
    ...
    def on_touch_down(self, touch):
        ...
        #  But without this, the list (`ScrollView`) placed in the `EZECard`
...
class RectangularRippleBehavior(CommonRipple):
    ...
    For more information, see in the :class:`~eze.uix.behavior.CommonRipple`
    class documentation.
    """
