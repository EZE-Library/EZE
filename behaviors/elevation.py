...
.. warning::
    ...
    If before the EZE 1.0.0 library version you used the elevation property
    with an average value of `12` for the shadow, then starting with the EZE
    1.0.0 library version, the average value of the elevation property will be
    somewhere `4`.
...
.. tabs::
    ...
    .. tab:: Declarative style with KV
        ...
        .. code-block:: python
            ...
            from eze.app import EZEApp
            from eze.uix.behaviors import CircularRippleBehavior, CommonElevationBehavior
...
.. tabs::
    ...
    .. tab:: Declarative style with KV
        ...
        .. code-block:: python
            ...
            from eze.app import EZEApp
            from eze.uix.behaviors import CommonElevationBehavior, RectangularRippleBehavior
...
class CommonElevationBehavior(Widget):
    ...
    .. code-block:: python
        ...
        from eze.app import EZEApp
        from eze.uix.behaviors import BackgroundColorBehavior, CommonElevationBehavior
