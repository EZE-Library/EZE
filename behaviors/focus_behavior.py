...
.. code-block:: python
    ...
    from eze.uix.behaviors import RectangularElevationBehavior
    ...
    class FocusWidget(EZEBoxLayout, RectangularElevationBehavior, FocusBehavior):
        pass
...
class FocusBehavior(HoverBehavior, ButtonBehavior):
    ...
    For more information, see in the :class:`~eze.uix.behavior.HoverBehavior`
    ...
    def on_enter(self):
        ...
        if (
            hasattr(self, "eze_bg_color") or hasattr(self, "bg_color")
    ...
    def _set_bg_color(self, color):
        if hasattr(self, "eze_bg_color"):
            self.eze_bg_color = color
