...
To use the :class:`~EZETooltip` class, you must create a new class inherited
from the :class:`~EZETooltip` class:

In Kv-language:

.. code-block:: kv

    <TooltipEZEIconButton@EZEIconButton+EZETooltip>

In Python code:

.. code-block:: python

    class TooltipEZEIconButton(EZEIconButton, EZETooltip):
        pass

.. Warning:: :class:`~EZETooltip` only works correctly with button and label classes.
...
__all__ = ("EZETooltip", "EZETooltipViewClass")
...
from eze.uix.behaviors import HoverBehavior, TouchBehavior
...
class EZETooltip(ThemableBehavior, HoverBehavior, TouchBehavior):
    """
    Tooltip class.

    For more information, see in the
    :class:`~eze.theming.ThemableBehavior and
    :class:`~eze.uix.behaviors.HoverBehavior` and
    ...
    def on_enter(self, *args) -> None:
        """
        See
        :attr:`~eze.uix.behaviors.hover_behavior.HoverBehavior.on_enter`
        method in :class:`~eze.uix.behaviors.hover_behavior.HoverBehavior`
        class.
        """
        ...
        if self.tooltip_text:
            ...
            self._tooltip = EZETooltipViewClass(
    ...
    def on_leave(self) -> None:
        """
        See
        :attr:`~eze.uix.behaviors.hover_behavior.HoverBehavior.on_leave`
        method in :class:`~eze.uix.behaviors.hover_behavior.HoverBehavior`
        class.
        """
...
class EZETooltipViewClass(ThemableBehavior, BoxLayout):
    """
    Tooltip view class.
    ...
    tooltip_bg_color = ColorProperty(None)
    """
    See :attr:`~EZETooltip.tooltip_bg_color`.
    """

    tooltip_text_color = ColorProperty(None)
    """
    See :attr:`~EZETooltip.tooltip_text_color`.
    """

    tooltip_text = StringProperty()
    """
    See :attr:`~EZETooltip.tooltip_text`.
    """

    tooltip_font_style = OptionProperty("Caption", options=theme_font_styles)
    """
    See :attr:`~EZETooltip.tooltip_font_style`.
    """

    tooltip_radius = ListProperty()
    """
    See :attr:`~EZETooltip.tooltip_radius`.
    """
