...
.. note:: `EZEDataTable` allows developers to sort the data provided by column.
    ...
    This is because the index list is needed to allow EZEDataTable to keep track
...
from eze.effects.stiffscroll import StiffScrollEffect
...
from eze.uix.behaviors import HoverBehavior
...
from eze.uix.selectioncontrol import EZECheckbox
...
class CellHeader(EZETooltip, BoxLayout):
    """
    Implements the label text in the column header panel from
    :attr:`~EZEDataTable.column_data` data.
    """
...
class TableHeader(ThemableBehavior, ScrollView):
    ...
    """
    See :attr:`~EZEDataTable.sorted_on`
    ...
    sorted_order = StringProperty()
    """
    See :attr:`~EZEDataTable.sorted_order`.
    ...
    """
    See :attr:`~EZEDataTable.background_color_header`.
...
class TableData(RecycleView):
    ...
    """
    See :attr:`~EZEDataTable.row_data`.
    ...
    """
    :class:`~eze.uix.menu.EZEDropdownMenu` class.
...
class TablePagination(EZEBoxLayout):
...
class EZEDataTable(ThemableBehavior, AnchorLayout):
    """
    Datatable class.
    ...
    .. code-block:: python
        ...
        from eze.uix.datatables import EZEDataTable
        from eze.uix.screen import EZEScreen


        class Example(EZEApp):
            def build(self):
                self.data_tables = EZEDataTable(
                    use_pagination=True,
                    check=True,
                    column_data=[
                        ("No.", dp(30)),
    ...
    `("EZEicon-name", [icon color in rgba], "Column Value")`
    ...
    """
    See :attr:`eze.uix.behaviors.elevation.CommonElevationBehavior.shadow_softness_size`
    attribute.
...
`
    ...
    """
    See :attr:`eze.uix.behaviors.elevation.CommonElevationBehavior.shadow_color`
    attribute.
    ...
    and defaults to :class:`~eze.effects.stiffscroll.StiffScrollEffect`.
    """
        ...
        .. code-block:: python
            ...
            class Example (EZEApp):
                ...
                def build(self):
                    ...
                    layout = EZEFloatLayout()  # root layout
                    # Creating control buttons.
                    button_box = EZEBoxLayout(
                ...
                def on_button_press(self, instance_button: EZERaisedButton) -> None:
    ...
    def update_row(
        ...
        .. code-block:: python
            ...
            class Example(EZEApp):
                ...
                def update_row(self, instance_button: EZERaisedButton) -> None:
    ...
    def create_pagination_menu(self, interval: Union[int, float]) -> None:
        ...
        pagination_menu = EZEDropdownMenu(
...
class CellRow(
    ...
    """Implements a data row from :attr:`~EZEDataTable.column_data`."""

    background_color_cell = ColorProperty(None)
    """
    See :attr:`~EZEDataTable.background_color_cell.`.
    ...
    background_color_selected_cell = ColorProperty(None)
    """
    See :attr:`~EZEDataTable.background_color_selected_cell.`.
    ...
    def notify_checkbox_click(
        self, instance_check: EZECheckbox, active: bool
    ) -> None:
    ...
    def select_check(
        self, instance_table_data: EZEDataTable, active: bool
    ) -> None:
...
class SortButton(EZEIconButton):
