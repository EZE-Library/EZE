...
.. code-block:: python
    ...
    from eze.uix.taptargetview import EZETapTargetView
    ...
    class TapTargetViewDemo(EZEApp):
        def build(self):
            screen = Builder.load_string(KV)
            self.tap_target_view = EZETapTargetView(
...
definitely specify the :attr:`~EZETapTargetView.title_position`.
...
- :attr:`~EZETapTargetView.title_text_size`
- :attr:`~EZETapTargetView.title_text_color`
- :attr:`~EZETapTargetView.title_text_bold`
- :attr:`~EZETapTargetView.description_text_size`
- :attr:`~EZETapTargetView.description_text_color`
- :attr:`~EZETapTargetView.description_text_bold`
...
.. code-block:: python
    ...
    self.tap_target_view = EZETapTargetView(
        ...
        description_text="[color=#E41C1CFF]Description text[/color]",
    )
...
.. Note:: See other parameters in the :class:`~EZETapTargetView` class.
"""
...
class EZETapTargetView(ThemableBehavior, EventDispatcher):
    ...
    """
    State of :class:`~EZETapTargetView`.
