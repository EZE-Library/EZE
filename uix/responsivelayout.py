...
The :class:`~EZEResponsiveLayout` class does not reorganize your UI. Its task
is to track the size of the application screen and, depending on this size,
the :class:`~EZEResponsiveLayout` class selects which UI layout should be
...
You need to set three parameters for the :class:`~EZEResponsiveLayout` class
:attr:`~EZEResponsiveLayout.mobile_view`,
:attr:`~EZEResponsiveLayout.tablet_view` and
:attr:`~EZEResponsiveLayout.desktop_view`. These should be Kivy or EZE
widgets.
...
.. code-block:: python
    ...
    from eze.uix.responsivelayout import EZEResponsiveLayout
    ...
    class CommonComponentLabel(EZELabel):
        pass


    class MobileView(EZEScreen):
        pass


    class TabletView(EZEScreen):
        pass


    class DesktopView(EZEScreen):
        pass


    class ResponsiveView(EZEResponsiveLayout, EZEScreen):
...
Perhaps you expected more from the :class:`~EZEResponsiveLayout` widget, but
...
class EZEResponsiveLayout(EventDispatcher, WindowController):
    """
    :Events:
    ...
    """
    Mobile view. Must be a Kivy or EZE widget.
    ...
    """
    Tablet view. Must be a Kivy or EZE widget.
    ...
    """
    Desktop view. Must be a Kivy or EZE widget.
