...
.. tabs::
    ...
    .. tab:: Declarative KV style
        ...
        .. code-block:: python
            ...
            from eze.uix.pickers import EZEDatePicker
            ...
            class Test(EZEApp):
                ...
                def on_save(self, instance, value, date_range):
                    ...
                    :type instance: <eze.uix.picker.EZEDatePicker object>;
...
.. code-block:: python
    ...
    def show_date_picker(self):
        date_dialog = EZEDatePicker(year=1983, month=4, day=12)
        date_dialog.open()
...
You can set the range of years using the :attr:`~eze.uix.picker.EZEDatePicker.min_year` and
:attr:`~eze.uix.picker.EZEDatePicker.max_year` attributes:

.. code-block:: python

    def show_date_picker(self):
        date_dialog = EZEDatePicker(min_year=2022, max_year=2030)
        date_dialog.open()
...
.. code-block:: python
    ...
    def show_date_picker(self):
        date_dialog = EZEDatePicker(mode="range")
        date_dialog.open()
...
__all__ = ("EZEDatePicker", "BaseDialogPicker", "DatePickerInputField")
...
from eze.uix.dialog import BaseDialog
...
class BaseDialogPicker(
    ...
    """
    Base class for :class:`~eze.uix.picker.EZEDatePicker` and
    :class:`~eze.uix.picker.EZETimePicker` classes.

    For more information, see in the
    :class:`~eze.uix.dialog.BaseDialog` and
    :class:`~eze.uix.behaviors.CommonElevationBehavior` and
    :class:`~eze.uix.behaviors.SpecificBackgroundColorBehavior`
    ...
    .. code-block:: python
        ...
        EZEDatePicker(title_input="INPUT DATE")
    ...
    .. code-block:: python
        ...
        EZEDatePicker(title="SELECT DATE")
    ...
    .. code-block:: python
        ...
        EZEDatePicker(primary_color="brown")
...
class DatePickerBaseTooltip(EZETooltip):
    """Implements tooltips for members of the :class:`~MDDatePicker` class."""

    owner = ObjectProperty()  # EZEDatePicker object
    hint_text = StringProperty()


class DatePickerIconTooltipButton(EZEIconButton, DatePickerBaseTooltip):
    pass


class DatePickerWeekdayLabel(EZELabel, DatePickerBaseTooltip):
    pass
...
class DatePickerInputField(EZETextField):
    """
...
class DatePickerInputFieldContainer(EZEBoxLayout):
    owner = ObjectProperty()  # EZEDatePicker object
...
class DatePickerYearSelectableItem(RecycleDataViewBehavior, EZELabel):
...
# TODO: Add the feature to embed the `EZEDatePicker` class in other layouts
...
class EZEDatePicker(BaseDialogPicker):
    ...
    .. code-block:: python
        ...
        class CustomInputField(EZETextField):
        ...
        def show_date_picker(self):
            date_dialog = EZEDatePicker(input_field_cls=CustomInputField)
    ...
    def get_field(self, date=None) -> EZETextField:
        """Creates and returns a text field object used to enter dates."""

        if issubclass(self.input_field_cls, EZETextField):
            text_color_focus = (
            ...
            raise TypeError(
                ...
                "`eze.uix.textfield.EZETextField class`"
            )
