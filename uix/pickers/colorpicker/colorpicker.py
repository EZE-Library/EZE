...
.. code-block:: python
    ...
    from eze.uix.pickers import EZEColorPicker
    ...
    EZEScreen:
        ...
        EZERaisedButton:
            ...
            eze_bg_color: toolbar.eze_bg_color
    ...
    class MyApp(EZEApp):
        ...
        def open_color_picker(self):
            color_picker = EZEColorPicker(size_hint=(0.45, 0.85))
            color_picker.open()
            color_picker.bind(
        ...
        def update_color(self, color: list) -> None:
            self.root.ids.toolbar.eze_bg_color = color

        def get_selected_color(
            self,
            instance_color_picker: EZEColorPicker,
            type_color: str,
...
from eze.color_definitions import colors as _colors
from eze.color_definitions import text_colors
from eze.uix.behaviors import RectangularRippleBehavior
...
from eze.uix.tab import EZETabs, EZETabsBase, EZETabsLabel

__all__ = ("EZEColorPicker",)
...
class TypeColorButton(EZERaisedButton, EZEToggleButton):
    """
...
class SelectAlphaChannelWidget(EZEBoxLayout):
    """
    ...
    # :class:`~eze.uix.colorpicker.EZEColorPicker` class.
...
class GradientTab(EZEBoxLayout):
    """
...
class TabColorList(EZEBoxLayout, EZETabsBase):
    """Implements a tab for :class:`~ColorListTab` class."""


class ColorListTab(EZETabs):
    """
    ...
    def generates_list_colors(
        ...
        instance_tabs_label: EZETabsLabel,
        tab_label_text: str,
    ) -> None:
        """
...
class ColorListItem(RectangularRippleBehavior, ButtonBehavior, EZEBoxLayout):
...
class EZEColorPicker(BaseDialog):
    ...
    def update_color_type_buttons(self, color: list) -> None:
        ...
        for instance_toggle_button in self.ids.type_color_button_box.children:
            if instance_toggle_button.state != "down":
                instance_toggle_button.eze_bg_color = color
    ...
    def on_select_color(self, color: list) -> None:
        ...
        self.ids.header.eze_bg_color = color
        self._rgb = color[:-1]
