...
.. tabs::
    ...
    .. tab:: Declarative KV style
        ...
        .. code-block:: python
            ...
            from eze.uix.pickers import EZETimePicker
...
.. code-block:: python
    ...
    def get_time(self, instance, time):
        ...
        :type instance: <eze.uix.picker.EZETimePicker object>
...
Use the :attr:`~EZETimePicker.set_time` method of the
:class:`~EZETimePicker.` class.
...
.. note:: For customization of the :class:`~EZETimePicker` class, see the
    documentation in the :class:`~eze.uix.pickers.datepicker.datepicker.BaseDialogPicker` class.
...
from eze.uix.circularlayout import EZECircularLayout
from eze.uix.label import EZELabel
from eze.uix.pickers.datepicker import BaseDialogPicker
...
class AmPmSelectorLabel(ButtonBehavior, EZELabel):
    pass


class AmPmSelector(EZEBoxLayout):
...
class TimeInputTextField(EZETextField):
...
class TimeInput(EZERelativeLayout):
...
class SelectorLabel(EZELabel):
    pass


class CircularSelector(EZECircularLayout, EventDispatcher):
...
class EZETimePicker(BaseDialogPicker):
