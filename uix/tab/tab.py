...
:class:`~EZETabsBase` class and the `Kivy` container, in which you will create
content for the tab.
...
All tabs must be contained inside a :class:`~EZETabs` widget:
        ...
        .. code-block:: python
            ...
            class Example(EZEApp):
                ...
                def on_tab_switch(
                    ...
                    :type instance_tabs: <eze.uix.tab.EZETabs object>;
                    :param instance_tab: <__main__.Tab object>;
                    :param instance_tab_label: <eze.uix.tab.EZETabsLabel object>;
        ...
        .. code-block:: python
            ...
            class Example(EZEApp):
                ...
                def build(self):
                    ...
                    return (
                        EZEBoxLayout(
                            EZETopAppBar(title="Example Tabs"),
                            EZETabs(id="tabs"),
                            orientation="vertical",
                        )
                    )
...
.. Note:: The :class:`~EZETabsBase` class has an icon parameter and, by default,
    tries to find the name of the icon in the file
    ``eze/icon_definitions.py``.
            ...
            class Example(EZEApp):
                ...
                def on_start(self):
                    ...
                    for i in range(20):
                        self.root.ids.tabs.add_widget(
                            Tab(
                                EZELabel(id="label", text="Tab 0", halign="center"),
                                title=f"Tab {i}",
                            )
                        )
    ...
    .. tab:: Declarative KV and imperative python styles
        ...
        .. code-block:: python
            ...
            class Example(EZEApp):
                ...
                def on_start(self):
                    for name_tab in list(eze_icons.keys())[15:30]:
...
.. tabs::
    ...
    .. tab:: Declarative KV and imperative python styles
        ...
        .. code-block:: python
            ...
            class Tab(EZEScrollView, EZETabsBase):
                '''Class implementing content for a tab.'''
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            from eze.uix.list import EZEList
            from eze.uix.scrollview import EZEScrollView
            from eze.app import EZEApp
            from eze.uix.boxlayout import EZEBoxLayout
            from eze.uix.tab import EZETabsBase, EZETabs
...
.. tabs::
    ...
    .. tab:: Declarative KV and imperative python styles
        ...
        .. code-block:: python
            ...
            from eze.app import EZEApp
            from eze.uix.floatlayout import EZEFloatLayout
            from eze.font_definitions import fonts
            from eze.uix.tab import EZETabsBase
            from eze.icon_definitions import eze_icons
            ...
            class Example(EZEApp):
                ...
                def on_ref_press(
                    ...
                    :param instance_tabs: <eze.uix.tab.EZETabs object>
                    :param instance_tab_label: <eze.uix.tab.EZETabsLabel object>
                    :param instance_tab: <__main__.Tab object>
                    :param instance_tab_bar: <eze.uix.tab.EZETabsBar object>
                    :param instance_carousel: <eze.uix.tab.EZETabsCarousel object>
                    '''
        ...
        .. code-block:: python
            ...
            class Example(EZEApp):
                ...
                def on_ref_press(
                    ...
                    :param instance_tabs: <eze.uix.tab.MEZETabs object>
                    :param instance_tab_label: <eze.uix.tab.MDTabsLabel object>
                    :param instance_tab: <__main__.Tab object>
                    :param instance_tab_bar: <eze.uix.tab.EZETabsBar object>
                    :param instance_carousel: <eze.uix.tab.EZETabsCarousel object>
                    '''
...
from eze.font_definitions import fonts, theme_font_styles
from eze.icon_definitions import eze_icons
from eze.theming import ThemableBehavior, ThemeManager
...
from eze.uix.carousel import EZECarousel
from eze.uix.label import EZELabel
...
class EZETabsException(Exception):
    pass


class EZETabsLabel(ToggleButtonBehavior, RectangularRippleBehavior, EZELabel):
...
class EZETabsBase:
    ...
    def __init__(self, *args, **kwargs):
        self.tab_label = EZETabsLabel(tab=self)
    ...
    def _update_text(self, *args):
        ...
        if self.title and self.title_is_capital is True:
            if self.title != self.title.upper():
                ...
                return
        # Add the icon.
        if self.icon and self.icon in eze_icons:
            self.tab_label_text = f"[size=24sp][font={fonts[-1]['fn_regular']}]{eze_icons[self.icon]}[/size][/font]"
            if self.title:
                self.tab_label_text = (
                    self.tab_label_text
        ...
        # Add the title.
            ...
            if self.icon:
                Logger.error(
                    f"{self}: [UID] = [{self.uid}]:\n\t"
                    f"Icon '{self.icon}' not found in eze_icons"
                )
            if self.title:
...
class EZETabsMain(EZEBoxLayout):
    """
...
class EZETabsCarousel(EZECarousel):
...
class EZETabsScrollView(ScrollView):
...
class EZETabsBar(EZECard):
    ...
    def tab_bar_autoscroll(self, instance_tab_label: EZETabsLabel, step: float):
    ...
    def android_animation(
        self, instance_carousel: EZETabsCarousel, offset: Union[float, int]
    ):
...
class EZETabs(
    ...
    """
    See :attr:`eze.uix.behaviors.CommonElevationBehavior.shadow_softness`
    attribute.
    ...
    """
    See :attr:`eze.uix.behaviors.CommonElevationBehavior.shadow_color`
    attribute.
    ...
    """
    See :attr:`eze.uix.behaviors.CommonElevationBehavior.shadow_offset`
    attribute.
    ...
    """
    See :attr:`eze.uix.behaviors.CommonElevationBehavior.elevation`
    attribute.
    ...
    def switch_tab(self, name_tab: Union[EZETabsLabel, str], search_by="text"):
        """
        This method switch between tabs
        name_tab can be either a String or a :class:`~EZETabsBase`.
    ...
    def get_tab_list(self) -> list:
        """Returns a list of :class:`~EZETabsLabel` objects."""
    ...
    def add_widget(self, widget, index=0, canvas=None):
        ...
        if not isinstance(widget, (EZETabsBase, EZETabsMain, EZETabsBar)):
            raise ValueError(
                f"EZETabs[{self.uid}].add_widget:\n\t"
                "The widget provided is not a subclass of EZETabsBase."
            )
        if len(self.children) >= 2:
            try:
                ...
                pass
        if isinstance(widget, (EZETabsMain, EZETabsBar)):
            return super().add_widget(widget)

    def remove_widget(self, widget):
        # You can remove only subclass of EZETabsLabel or EZETabsBase.
        if not issubclass(widget.__class__, (EZETabsLabel, EZETabsBase)):
            raise EZETabsException(
                "EZETabs can remove only subclass of EZETabsLabel or EZETabsBase"
            )
        # If the widget is an instance of EZETabsBase, then the widget is
        # set as the widget's tab_label object.
        if issubclass(widget.__class__, EZETabsBase):
            slide = widget
