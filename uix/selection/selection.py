...
.. code-block:: python
    ...
    from eze.uix.list import TwoLineAvatarListItem
    ...
    class Example(EZEApp):
        ...
        def set_selection_mode(self, instance_selection_list, mode):
            if mode:
                eze_bg_color = self.overlay_color
                left_action_items = [
                    [
                        "close",
            ...
            Animation(eze_bg_color=eze_bg_color, d=0.2).start(self.root.ids.toolbar)
...
class SelectionIconCheck(EZEIconButton):
...
class SelectionItem(EZERelativeLayout, TouchBehavior):
    ...
    """
    User item. Must be a Kivy or EZE widget.
    ...
    """
    Instance of :class:`~eze.uix.selection.SelectionIconCheck` class.
...
class EZESelectionList(EZEList):
    """
    Selection list class.

    For more information, see in the
    :class:`~eze.uix.list.EZEList` classes documentation.
    ...
    def add_widget(self, widget, index=0, canvas=None):
        selection_icon = SelectionIconCheck(
            icon=self.icon,
            eze_bg_color=self.icon_bg_color,
    ...
    def get_selected_list_items(self) -> list:
        ...
        [<eze.uix.selection.SelectionItem object>, ...]
        """
