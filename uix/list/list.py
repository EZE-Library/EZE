...
The class :class:`~EZEList` in combination with a :class:`~BaseListItem` like
...
For this `EZE` provides list items that try to cover the most common usecases,
...
`EZE` provides the following list items classes for use:
...
`EZE` provides base classes such as :class:`~ImageLeftWidget`,
...
.. tabs::
    ...
    .. tab:: Declarative KV style
        ...
        .. code-block:: python
            ...
            from eze.uix.list import OneLineListItem
...
.. tabs::
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            from eze.uix.list import MDList, OneLineAvatarIconListItem, IconLeftWidget
    ...
    .. tab:: Declarative KV style
        ...
        .. code-block:: kv
            ...
            OneLineAvatarListItem:
                ...
                ImageLeftWidget:
                    source: "eze/images/logo/eze-icon-256.png"
...
.. tabs::
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            class RightCheckbox(IRightBodyTouch, EZECheckbox):
                '''Custom right container.'''
...
.. tabs::
    ...
    .. tab:: Declarative KV style
        ...
        .. code-block:: python
            ...
            from eze.uix.list import IRightBodyTouch
            ...
            class YourContainer(IRightBodyTouch, EZEBoxLayout):
                adaptive_width = True
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            from eze.uix.list import OneLineAvatarIconListItem, IconLeftWidget
...
from eze.uix.gridlayout import EZEGridLayout
from eze.uix.selectioncontrol import EZECheckbox
...
class EZEList(EZEGridLayout):
    ...
    :class:`~eze.uix.gridlayout.EZEGridLayout` classes documentation.
    """
...
class ImageLeftWidget(
    ...
    :class:`~eze.uix.fitimage.FitImage` classes documentation.
    """
...
class IconRightWidget(IRightBodyTouch, EZEIconButton):
    """
    The widget implements the right icon for use in ListItem classes.

    For more information, see in the
    :class:`~IRightBodyTouch` and
    :class:`~eze.uix.button.EZEIconButton`
    classes documentation.
    """
...
class IconRightWidgetWithoutTouch(TouchBehavior, IRightBody, EZEIconButton):
    """
...
class IconLeftWidget(ILeftBodyTouch, EZEIconButton):
    """
...
class IconLeftWidgetWithoutTouch(TouchBehavior, ILeftBody, EZEIconButton):
    """
    Disables the icon event.
    The widget implements the left icon for use in ListItem classes.
...
class CheckboxLeftWidget(ILeftBodyTouch, EZECheckbox):
    """
    The widget implements the left checkbox element for use in ListItem classes.

    For more information, see in the
    :class:`~ILeftBodyTouch` and
    :class:`~eze.uix.selectioncontrol.EZECheckbox`
    classes documentation.
    """
