...
`EZE` provides the following field classes for use:

- EZETextField_
- EZETextFieldRect_

.. Note:: :class:`~EZETextField` inherited from
    ...
    available in the :class:`~EZETextField` class.

.. EZETextField:
EZETextField
-----------

:class:`~EZETextField` can be with helper text and without.
...
.. Note:: :class:`~EZETextFieldRect` inherited from
...
Clickable icon for EZETextField
------------------------------
...
.. code-block:: python
    ...
    class ClickableTextFieldRound(EZERelativeLayout):
        text = StringProperty()
        hint_text = StringProperty()
        # Here specify the required parameters for EZETextFieldRound:
        # [...]
...
.. seealso::
    ...
    See more information in the :class:`~EZETextFieldRect` class.
"""

__all__ = ("EZETextField", "EZETextFieldRect")
...
class EZETextFieldRect(ThemableBehavior, TextInput):
    """
...
class TextfieldLabel(ThemableBehavior, Label):
    """Base texture for :class:`~EZETextField` class."""

    font_style = OptionProperty("Body1", options=theme_font_styles)
    # <eze.uix.textfield.EZETextField object>
...
class EZETextField(
    ...
    # `EZEIcon` object for the icon on the right.
    _icon_right_label = None
    # `EZEIcon` object for the icon on the left.
    ...
    def set_objects_labels(self) -> None:
        ...
        self._icon_right_label = EZEIcon(theme_text_color="Custom")
        self._icon_left_label = EZEIcon(theme_text_color="Custom")
    ...
    def _get_has_error(self) -> bool:
        ...
        the :attr:`~EZETextField.required` parameter is set to `True`.
        """
