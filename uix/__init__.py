...
class EZEAdaptiveWidget(SpecificBackgroundColorBehavior):
    ...
    def on_adaptive_height(self, eze_widget, value: bool) -> None:
    ...
    def on_adaptive_width(self, eze_widget, value: bool) -> None:
    ...
    def on_adaptive_size(self, eze_widget, value: bool) -> None:
