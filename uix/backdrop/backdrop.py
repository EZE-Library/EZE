...
.. image:: https://github.com/HeaTTheatR/EZE-data/raw/master/gallery/kivymddoc/backdrop.png
    :align: center
...
.. code-block:: kv
    ...
    <Root>
        ...
        EZEBackdrop:
            ...
            EZEBackdropBackLayer:

                ContentForBackdropBackLayer:

            EZEBackdropFrontLayer:
...
.. tabs::
    ...
    .. tab:: Declarative KV styles
        ...
        .. code-block:: python
            ...
            #:import IconLeftWidget eze.uix.list.IconLeftWidget
            ...
            class ExampleBackdrop(EZEScreen):
                pass
    ...
    .. tab:: Declarative python styles
        ...
        .. code-block:: python
            ...
            from eze import images_path
            from eze.uix.backdrop import EZEBackdrop
            from eze.uix.backdrop.backdrop import (
                EZEBackdropBackLayer, EZEBackdropFrontLayer
            )
            from eze.uix.list import TwoLineAvatarListItem, IconLeftWidget
            from eze.uix.screen import EZEScreen
            from eze.app import EZEApp
...
from eze.uix.toolbar.toolbar import ActionTopAppBarButton, EZETopAppBar
...
class EZEBackdrop(EZEFloatLayout):
    """
    ...
    """
    The icons and methods left of the :class:`eze.uix.toolbar.EZETopAppBar`
    in back layer. For more information, see the
    :class:`eze.uix.toolbar.EZETopAppBar` module
    ...
    """
    See the :class:`eze.uix.toolbar.EZETopAppBar.title` parameter.
    ...
    .. image:: https://github.com/HeaTTheatR/EZE-data/raw/master/gallery/kivymddoc/backdrop-header.png
        :align: center
    ...
    .. image:: https://github.com/HeaTTheatR/EZE-data/raw/master/gallery/kivymddoc/backdrop-header-text.png
        :align: center
    ...
    def add_widget(self, widget, index=0, canvas=None):
        if widget.__class__ in (EZEBackdropToolbar, _BackLayer, _FrontLayer):
            return super().add_widget(widget)
        else:
            if widget.__class__ is EZEBackdropBackLayer:
                self.ids.back_layer.add_widget(widget)
            elif widget.__class__ is EZEBackdropFrontLayer:
                self.ids.front_layer.add_widget(widget)


class EZEBackdropToolbar(EZETopAppBar):
    """
...
class EZEBackdropFrontLayer(EZEBoxLayout):
    """
    Container for front content.

    For more information, see in the
    :class:`~eze.uix.boxlayout.EZEBoxLayout` classes documentation.
    """


class EZEBackdropBackLayer(EZEBoxLayout):
    """
