...
.. rubric:: The :class:`EZELabel` widget is for rendering text.
...
Class :class:`EZELabel` inherited from the :class:`~kivy.uix.label.Label` class
but for :class:`EZELabel` the ``text_size`` parameter is ``(self.width, None)``
...
:class:`~EZELabel` color:
------------------------

:class:`~EZELabel` provides standard color themes for label color management:
...
To use a custom color for :class:`~EZELabel`, use a theme `'Custom'`.
...
:class:`~EZELabel` provides standard font styles for labels. To do this,
specify the name of the desired style in the :attr:`~EZELabel.font_style`
parameter:
    ...
    .. tab:: Declarative Python style
        ...
        .. code-block:: python
            ...
            class Example(EZEApp):
                ...
                def on_copy(self, instance_label: EZELabel):
...
The :class:`~EZEIcon` class is inherited from
:class:`~EZELabel` and has the same parameters.

.. Warning:: For the :class:`~EZEIcon` class, you cannot use ``text``
...
from eze.theming_dynamic_text import get_contrast_text_color
from eze.uix import EZEAdaptiveWidget
from eze.uix.behaviors import DeclarativeBehavior, TouchBehavior
...
class EZELabel(
    ...
    :class:`~eze.uix.behaviors.TouchBehavior`
    ...
    def on_theme_text_color(
        ...
        if op:
            self._text_color_str = __EZELabel_colors__.get("OP", "").get(
                theme_text_color, ""
            )
        else:
            self._text_color_str = __EZELabel_colors__.get(theme_text_color, "")
    ...
    def on_eze_bg_color(self, instance_label, color: Union[list, str]) -> None:
...
class EZEIcon(EZEFloatLayout, EZELabel):
    """
    Icon class.

    For more information, see in the :class:`~EZELabel` and
    :class:`~eze.uix.floatlayout.EZEFloatLayout` classes documentation.
    """
    ...
    def adjust_size(self, *args) -> None:
        ...
        if not isinstance(self, EZECheckbox):
