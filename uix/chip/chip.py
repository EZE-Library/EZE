...
.. tabs::
    ...
    .. tab:: Declarative Python style
        ...
        .. code-block:: python
            ...
            from eze.app import EZEApp
            from ezeeze.uix.chip import EZEChip, EZEChipText
            from kivymd.uix.screen import EZEScreen
...
.. code-block:: python
    ...
    KV = '''
    <CommonLabel@EZELabel>
        adaptive_size: True
        theme_text_color: "Custom"
        text_color: "#e6e9df"


    <CommonAssistChip@EZEChip>
        # Custom attribute.
        text: ""
        icon: ""
...
.. code-block:: python
    ...
    from eze.app import EZEApp
    from eze.uix.chip import EZEChip, EZEChipText
    ...
    <PreviewIconsScreen>
        ...
        EZEBoxLayout:
            ...
            EZETextField:
                ...
                mode: "rectangle"
                icon_left: "magnify"
                on_text: root.set_list_eze_icons(self.text, True)
    ...
    class PreviewIconsScreen(EZEScreen):
        ...
        def set_list_eze_icons(self, text="", search=False) -> None:
            ...
            self.ids.rv.data = []
            for name_icon in eze_icons.keys():
...
.. code-block:: python
    ...
    class ChipScreen(EZEScreen):
        ...
        def uncheck_chip(self, current_chip: EZEChip, active: bool) -> None:
...
from eze.uix.label import EZEIcon, EZELabel
...
class BaseChipIcon(
    CircularRippleBehavior, ScaleBehavior, ButtonBehavior, EZEIcon
):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
    ...
    def adjust_icon_size(self, *args) -> None:
        ...
        if (
            ...
            self.font_size = (
                "18sp"
                if not self.source and not isinstance(self, EZEChipLeadingAvatar)
                else "24sp"
            )
        if self.source and isinstance(self, EZEChipLeadingAvatar):
...
class LabelTextContainer(EZEBoxLayout):
    """Implements a container for the chip label."""


class LeadingIconContainer(EZEBoxLayout):
    """Implements a container for the leading icon."""


class TrailingIconContainer(EZEBoxLayout):
    """Implements a container for the trailing icon."""


class EZEChipLeadingAvatar(BaseChipIcon):
    """
...
class EZEChipLeadingIcon(BaseChipIcon):
    """
...
class EZEChipTrailingIcon(BaseChipIcon):
    """
...
class EZEChip(
    ...
    _current_eze_bg_color = ColorProperty(None)
    ...
    def complete_anim_ripple(self, *args) -> None:
        ...
        if self.active:
            ...
            self.set_chip_bg_color(self._current_eze_bg_color)
    ...
    def set_chip_bg_color(self, color: list | str) -> None:
        ...
        if color:
            Animation(eze_bg_color=color, d=0.2).start(self)
    ...
    def add_widget(self, widget, *args, **kwargs):
        def add_icon_leading_trailing(container):
            if len(container.children):
                type_icon = (
                    "'leading'"
                    if isinstance(
                        widget, (EZEChipLeadingIcon, EZEChipLeadingAvatar)
                    )
                    else "'trailing'"
                )
                Logger.warning(
                ...
                return
            if isinstance(widget, EZEChipTrailingIcon) and self.type in [
                "assist",
                "suggestion",
            ]:
                Logger.warning(
                ...
                return
            if (
                isinstance(widget, EZEChipTrailingIcon)
                ...
                return
            if (
                isinstance(widget, (EZEChipLeadingIcon, EZEChipLeadingAvatar))
                and self.type == "filter"
            ):
                Logger.warning(
                    "EZE: "
            ...
            if (
                isinstance(widget, EZEChipLeadingAvatar)
        ...
        if isinstance(widget, EZEChipText):
        ...
        elif isinstance(widget, (EZEChipLeadingIcon, EZEChipLeadingAvatar)):
            Clock.schedule_once(
                lambda x: add_icon_leading_trailing(
                    self.ids.leading_icon_container
                )
            )
        elif isinstance(widget, EZEChipTrailingIcon):
            Clock.schedule_once(
                lambda x: add_icon_leading_trailing(
    ...
    def _set_allow_chip_ripple(
        self, instance: EZEChipLeadingIcon | EZEChipTrailingIcon
    ) -> None:
