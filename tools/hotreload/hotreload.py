...
.. note::
    ...
    EZE library and hope that the further development of the hot reload
...
from eze.app import EZEApp # NOQA E402
from monotonic import mnotonic # type: ignore
...
class HotReload(BaseApp):
    ...
    def set_error(self, exc, tb=None):
        ...
        scroll = Factory.EZEScrollView(
            scroll_y=0, eze_bg_color=get_color_from_hex("#e50000")
        )
        lbl = Factory.Label(
