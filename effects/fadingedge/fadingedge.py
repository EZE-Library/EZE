...
The `FadingEdgeEffect` class implements a fade effect for `EZE` widgets:
...
.. code-block:: python
    ...
    from eze.effects.fadingedge.fadingedge import FadingEdgeEffect
